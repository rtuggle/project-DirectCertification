...
race_weights = [0.40, 0.23, 0.22, 0.07, 0.01, 0.07]
...
#Now take 75 Kids and add in the guessing error
n = 30
res = records_gen(race_weights, n)
snap = res.copy()
school = res.copy()
...
#Now Take 75 kids and add in the typo error
n = 30
res = records_gen(race_weights, n)
snap = res.copy()
school = res.copy()
...
#Now Take 40 kids and add in both errors
n = 20
res = records_gen(race_weights, n)
snap = res.copy()
school = res.copy()
...
snap = res.copy()
school = res.copy()
school["Last Name"] = last_both(school["Last Name"], n)
#Assign Identifiers
school["ELIGIBLE"] = True
school["ERRORS"] = True
...
#Now Take 6 Names, make birthday 01 and put them in the school and snap
n = 6
res = records_gen(race_weights, n)
snap = res.copy()
school = res.copy()
...
#Now Take 10 Names, make exact match and put them in the school and snap
n = 10
res = records_gen(race_weights, n)
snap = res.copy()
school = res.copy()
...
#Now take 8 names, make first name guessing&typo error and put them in snap, put original in 
# school
n = 8
res = records_gen(race_weights,n)
school = res.copy()
...
#Now take 6 names, make last name guessing error and put them in snap, put original in 
n = 6
res = records_gen(race_weights,n)
school = res.copy()
snap = res.copy()
...
n = 10
silver_bullet_index = random.choice(range(0,230),n)
res = records_gen(race_weights, n)
...
school_final["City"] = "Oopstown"
snap_final["City"] = "Oopstown"
...
#Save the data files
school_final.to_csv("school2_mod.csv")
snap_final.to_csv("snap2_mod.csv")
